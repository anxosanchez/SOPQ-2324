...
$$
Lei \; de \; Raoult: K_i = \frac {p^{sat}_i (T)} {p}
$$
...
Unha mestura líquida contén 50% de pentano, 30% de hexano e 20% de ciclohexano (en moles), é dicir, $x_{pentano} = 0.5; x_{hexano} = 0.3 e x_{ciclohexano} = 0.2$. A $T = 400 K$ se baixa a presión gradualmente. Cál é a presión de burbulla e a composición do primeiro vapor que condensa?. Supoñer unha mestura líquida ideal e gas ideal (_lei de Raoult_).
