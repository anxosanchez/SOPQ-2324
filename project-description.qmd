...
**O Proxecto**: *Pilla unha idea ou concepto da Enxeñaría Química e desenvóolvea en forma de demostración, utilidade, simulación ou programa de cálculo ou deseño. Ese é o verdadeiro obxecivo.*

O obxectivo do proxecto final é que uses a simulación ou a optimización para ilustar de algún xeito algúns dos aspectos mais importantes da enxeñaría química.

O modelo no que te basees xa pode existir, ou ben, podes plantexar un por ti mesmo sobre algún tema que che insterse especialmente, ou buscalo na web.

O obxectivo deste proxecto é que demostre as competencias adquiridas na materia en forma de un caso práctico xa sexa de deseño, solución, mellora ou simple simulación demostrativa.
...
Todas os traballo deben estar acompañados da súa documentación, tanto do obxectivo, método, algortimo, código e interface, así comop un emmplod e aplicación xa terminado.
...
Os catro entregables primarios para o proxecto final son
...
- Unha presentación en formato slides mais unha presentación de vídeo
