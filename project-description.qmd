...
[Ideas para o proxecto](#topic-ideas) ata Venres, 27 de Outubro

[Propota de proxecto](#project-proposal) ata Venres, 3 de Novembro 

[Borrador de informe](#draft-report) ata Venres, 1 de Decembro

[Informe Final](#written-report) ata Venres, 8 de Decembro 
...
- [Presentacións de gravación en Zoom] (https://kb.siue.edu/61721)
...
Todo o traballo escrito (con excepción das diapositivas de presentación) debe ser reproducible e o repo de GitHub debería estar ben organizado.

O ficheiro comprimido, ou disco compartido, debería ter a seguinte estrutura:
...
Os puntos para a reproducibilidade + a organización estarán baseados na reproducibilidade do informe escrito e na organización do proxecto GitHub Repo.
O repo debe estar organizado perfectamente como se describe anteriormente, non debería haber ficheiros alleos, todo o texto no ReadMe debe ser facilmente lexible.
## Puntuación final
